    ...
    <div class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post">
                ...
                <div class="mt-3">
                    <button class="btn btn-success" type="submit" name="simpan_kategori">Tambah</button>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_array($querykategori)) {
                            ...
                            <tr>
                                ...
                                <!-- ini digunakan untuk mengkoneksikan halaman detail kategori untuk menampilkan id yng berada di database -->
                                <td><a href="kategori-detail.php?id=<?php echo $data['id']; ?>" class="btn btn-secondary"><i
